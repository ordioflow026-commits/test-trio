      ...
      zp.setCallInvitationConfig({
        ...
        onIncomingCallReceived: (callID: string, caller: any, callType: number) => {
          const updateTextSafely = () => {
            ...
            elements.forEach(el => {
              // 💡 Target the original text node safely
              if (el.textContent === 'Incoming call...') {
                ...
                // 💡 Custom Beautiful SVGs - Clear and Beautiful
                ...
                // A cleaner, call-focused video icon (camera with phone handset integrated)
                ...
                // Injecting a beautiful oversized glowing UI
                el.innerHTML = `
