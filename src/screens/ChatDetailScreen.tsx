        ...
        {recordedAudioBlob ? (
          ...
          <div className="flex items-end gap-2">
            <div className="flex-1 bg-[#009fb7] rounded-[28px] flex items-center shadow-sm pl-4 pr-1 min-h-[48px]">
              <textarea value={messageText} onChange={e => setMessageText(e.target.value)} placeholder="Message" className="flex-1 bg-transparent text-white outline-none py-3 resize-none max-h-32" rows={1} />
            ...
            <div className="shrink-0 mb-[1px]">
              <button onClick={messageText.trim() ? handleSendMessage : startRecording} className="w-[48px] h-[48px] bg-[#00E5FF] rounded-full flex items-center justify-center text-[#0f172a] shadow-md">
