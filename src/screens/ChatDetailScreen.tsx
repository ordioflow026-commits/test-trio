      ...
      <header className="flex items-center justify-between px-3 py-4 z-20">
        ...
        <div className="flex items-center gap-5 text-white pr-2">
          ...
          <button 
            ...
            className="hover:text-slate-200 transition-colors"
          >
            <Phone strokeWidth={1.5} className="w-[20px] h-[20px]" />
          </button>
        </div>
      </header>
                  ...
                  <div key={msg.id || idx} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                    <div 
                      ...
                      {msg.content.startsWith('Audio: ') ? (
                        <div className="mt-1 min-w-[220px] h-[45px] flex items-center bg-white/10 rounded-full overflow-hidden px-1">
                          <audio controls src={msg.content.replace('Audio: ', '')} style={{ width: '100%', height: '40px' }} className="w-full"></audio>
                        </div>
      ...
      <footer className="px-2 pb-3 mb-safe z-40 w-full relative">
        {recordedAudioBlob ? (
          ...
          <div className="flex items-center gap-2 bg-[#009fb7] p-1 pl-2 rounded-[28px] shadow-sm animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex-1 flex items-center justify-center px-2 min-w-[200px]">
              <audio src={URL.createObjectURL(recordedAudioBlob)} controls style={{ width: '100%', height: '40px' }}></audio>
            </div>
