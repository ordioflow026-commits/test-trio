...
import { Lock, Plus, LogIn, Copy, ArrowLeft, Check, Key, User, Loader2, AlertCircle, Share2, Eye, EyeOff, Trash2, Search, Sparkles } from 'lucide-react';
...
export default function PrivateRoomScreen() {
  ...
  const handleJoin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setView('room');
      setJoinLink(''); // 💡 التحديث: تفريغ حقل الرابط بعد نجاح الانضمام
